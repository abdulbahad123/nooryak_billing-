...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected $subdomainModuleNamespace = 'Modules\StockiflySaasSubdomain\App\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            if ($module && $module->isEnabled() && app_type() == 'saas' && file_exists(storage_path('installed'))) {
                Route::middleware('web')
                    ->namespace($this->subdomainModuleNamespace)
                    ->group(base_path('Modules/StockiflySaasSubdomain/routes/web.php'));
            }
